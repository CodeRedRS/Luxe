 ...
 */
$('body').append("<div id='quote' class='bounce hidden-md hidden-sm hidden-xs' style='display: none;'><a href='contact.html' class='btn btn-default btn-xl'>Free Quote!</a></div>");
if ($(document).width() < 768) $('.bounce').removeClass('bounce');
